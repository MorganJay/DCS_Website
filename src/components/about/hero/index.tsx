...
import about from '/public/images/sections/about.svg';
        ...
        <div className="row align-items-center">
          ...
          <div className="c col-lg-6 col-12">
            <div className="right-side text-lg-end text-center">
              <Image className="w-75 img-fluid mb-5" src={about} alt="about" />
              <div className="mx-auto dc text-center">
                <Link className="cources text-capitalize" href="/courses">
