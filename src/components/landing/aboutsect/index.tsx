        ...
        <div className="c col-lg-12">
          <div className="mb-lg-0 mb-5">
            ...
            <p className="desc pb-3">
              ...
              opportunity to thrive and reach their full potential. We envision
              a future where families are supported, children are nurtured, and
            ...
            <p className="desc pb-3">
              ...
              nurturing children's talents and potential
            </p>
          </div>
        </div>
