...
import { ENTITY_PHONE, ENTITY_ADDRESS, NAVBAR_ITEMS, SOCIAL_ACCOUNTS_LIST } from '@/assets/website-data';
      ...
      <div className="container px-4 d-flex justify-content-end align-items-center text-white">
        <div className='d-flex justify-content-end align-items-center'>
          <div className='d-none d-md-block'>
            <a href={`tel:${ENTITY_PHONE}`}><i className="fas fa-phone-alt mx-2"></i>{ENTITY_PHONE}</a>
            <i className="fas fa-map-marker-alt mx-2"></i>{ENTITY_ADDRESS}
          </div>
        <div className='d-flex justify-content-end align-items-center'>
